...
import searchConfig from './config/category/searchConfig'
import listConfig from './config/category/listConfig'
...
const delOne = (id: number) => {
  mainStore.deleteOne('category', id)
}
